...
extension GameViewController: MTKViewDelegate {
    ...
    public func draw(in view: MTKView) {
        ...
        var input = GMInput(
            ...
            touchCoords: isTouching ? GMTouchCoords(position: Float2(Float(self.mouseLocation.x), Float(self.mouseLocation.y))).toWorldSpace(screenWidth: viewWidth, screenHeight: viewHeight, flipY: false) : nil
        )
